...
CREATE TABLE `que` (
  `id` int(11) UNSIGNED NOT NULL,
  `que` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '問卷名稱',
  `subject` int(11) UNSIGNED NOT NULL COMMENT '分類',
  `count` int(11) UNSIGNED NOT NULL COMMENT '投票數'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `que` (`id`, `que`, `subject`, `count`) VALUES
(1, '你最常做什麼運動來促進健康體能呢?', 0, 1),
...
(8, '2.對孩子的的健康會產生許多影響，例如容', 6, 0),
(9, '3.孕婦吸入二手菸易造成流產', 6, 1),
(10, '4.長期的暴露會造成更嚴重的胸腔問題和過敏', 6, 1);
