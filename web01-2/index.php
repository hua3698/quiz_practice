        ...
        <div id="ms">
                ...
                <div id="menuput" class="dbor">
                    ...
                    ?>
                        <div class="mainmu">
                            ...
                            <div class="mw" style="position:absolute;z-index:55;width:200px;left:30px;top:20px;">
                                <?php
                                $sub = $Menu->all(['parent' => $m['id']]);
                                foreach ($sub as $s) {
                                ?>
                                    <div class="mainmu2">
                                        <a style="color:#000; font-size:13px; text-decoration:none;" href="<?= $s['href']; ?>"><?= $s['href']; ?></a>
                                    </div>
                                <?php
                                }
                                ?>
            ...
            <div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
                ...
                if (!empty($_SESSION['login'])) {
                    echo "<button style='width:100%; margin-left:auto; margin-right:auto; margin-top:2px; height:50px;'
